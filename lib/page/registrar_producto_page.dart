...
class RegistrarProductoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  ChangeNotifierProvider(
            ...
            child:_bodyPage(size: size, productoService: productoService,)
    );
  }
}
...
class _bodyPage extends StatelessWidget {
  const _bodyPage({
    Key? key, required this.productoService,
    required this.size,
  }) : super(key: key);
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          : Padding(
            ...
            child: IconButton(
              icon: Icon(Icons.delete_outline, color: Colors.red[300], size: 40,),
              onPressed: productoService.isSaving
                ? null
                : () async {
                await productoService.deleteProduct(productForm.producto);
        ...
        child: Column(
          children: [
            ...
            TextFormField(
              ...
              ? producto.price = 0 : producto.price = double.parse(value)
            ),
            const SizedBox(height: 20,),
            TextFormField(
