          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                const Center(child: Text('Datos Usuario', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),)),
                const SizedBox(height: 20,),
                ChangeNotifierProvider(
                  create: ( _ ) => UsuarioActualizarFromProvider(usuarioService.selectUsuario),
                  child: _RegisterForm(),
                ),
                const SizedBox(height: 20)
              ],
        ...
        child: Column(
          children: [
            ...
            TextFormField(
              ...
              validator: (value){
                return (value != null && value.length >= 2) ? null : 'debe ser de 2 o mas caracteres';
              },
            ),
            const SizedBox(height: 20,),
            TextFormField(
              ...
              validator: (value){
                return (value != null && value.length == 10) ? null : 'el numero lleva 10 digitos';
              },
            ),
            const SizedBox(height: 20,),
            TextFormField(
            ...
            TextFormField(
              ...
              validator: (value){
                return (value != null && value.length >= 5) ? null : 'debe ser de 5 o mas caracteres';
              },
            ),
            ...
            MaterialButton(
              ...
              child: Container(
                ...
                child: const Text('Actualizar', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white),),
              ),
              onPressed: registerService.isLoading ? null : () async {
                ...
                final String? messageRegistro = await usuarioService.updateUser(
                  Usuario(
