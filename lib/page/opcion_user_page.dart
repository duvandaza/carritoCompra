...
class OpcionUserPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Opciones de Usuario', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 25),),
        centerTitle: true,
        elevation: 0,
            ...
            MaterialButton(
              ...
              child: Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: const [
                    Icon(Icons.assignment_ind_sharp, size: 40, color: Colors.white,),
                    SizedBox(width: 10,),
                    Text('Datos', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.white),),
                  ],
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: const [
                    ...
                    SizedBox(width: 10,),
                    Text('Logaut', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.white),),
                  ],
                ),
              ),
            )
