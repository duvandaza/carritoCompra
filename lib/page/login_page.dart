          ...
          children: [
            ...
            Column(
              children: [
                ...
                const Center(child: Text('LOGIN ', style: TextStyle( fontSize: 30, fontWeight: FontWeight.bold, color: Colors.white),)),
                ...
                TextButton(
                  ...
                  child: Text('Registrarse', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.deepPurpleAccent[400]),)
                ),
...
class _loginForm extends StatelessWidget {
          ...
          children: [
            ...
            MaterialButton(
              ...
              onPressed: loginForm.isLoading ? null : () async {
                ...
                final usuario = Provider.of<UsuarioService>(context, listen: false);
                ...
                if( message == null ) {
                  ...
                  displayDialog(context,'Usuario o contraseña incorrecto', Icons.error, Colors.red, 'Error');
  ...
  void displayDialog(BuildContext context, String message, IconData icon, Color color, String titulo){
