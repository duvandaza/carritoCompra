        ...
        child: GridView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                ...
                child: _Card(producto: productos[index],)
              );
          },
        ),
      ),
      floatingActionButton: (authService.validatorAdmin) ? FloatingActionButton(
        ...
        onPressed: (){
          ...
          child: Icon(Icons.shopping_cart_checkout_sharp, size: 35,),
          onPressed: () async{
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(producto.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const SizedBox(height: 5),
          Text(
            '\$ ${producto.price}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16), 
          ),
